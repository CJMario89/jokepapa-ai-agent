...
export class ClientBase extends EventEmitter {
  ...
  async cacheIsProcessingTweet(isProcessing: boolean) {
    await this.runtime.cacheManager.set(
      `twitter/${this.profile.username}/is_processing_tweet`,
      isProcessing
    );
  }

  async getIsProcessingTweet(): Promise<boolean> {
    return await this.runtime.cacheManager.get<boolean>(
      `twitter/${this.profile.username}/is_processing_tweet`
    );
  }
